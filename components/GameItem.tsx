...
export default function GameItem({ games }: SnookerItemProps) {
  ...
  return (
    <>
      ...
      >
        <div>
          <p className="mb-1 ml-4 text-left">Player 1</p>
          <input
          ...
          />
          <p className="mb-1 ml-4 text-left">Player 2</p>
          <input
        ...
        <div>
          <p className="mb-1 text-left">Player 1 Score</p>
          <input
          ...
          />
          <p className="mb-1 text-left">Player 2 Score</p>
          <input
            className="bg-slate-600 shadow-gray-800 shadow-md me-4 mb-4 p-2 rounded-md grow"
            type="text"
        ...
        <button
          className="bg-red-600 hover:bg-red-400 shadow-gray-800 shadow-md ms-4 mr-4 p-3 rounded-md text-white"
